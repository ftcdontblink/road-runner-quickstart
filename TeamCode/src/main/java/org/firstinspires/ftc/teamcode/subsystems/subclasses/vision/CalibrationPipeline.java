...
import org.firstinspires.ftc.teamcode.subsystems.subclasses.vision.CalibUtil;
...
public class CalibrationPipeline extends OpenCvPipeline {
    ...
    public static int HORIZONTAL_CORNERS = 12;
    public static int VERTICAL_CORNERS = 9;
    public static double SQUARE_SIZE = 1;
